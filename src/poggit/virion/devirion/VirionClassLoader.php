...
class VirionClassLoader extends BaseClassLoader{
	...
	private Threaded $messages;

	private Threaded|array $antigenMap;

	private Threaded|array $mappedClasses;
	...
	public function getSourceViralAntigen(string $loadedClass) : ?string{ return $this->mappedClasses[$loadedClass] ?? null; }

	public function getMessages() : Threaded{ return $this->messages; }
}
